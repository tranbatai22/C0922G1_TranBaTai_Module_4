...
public interface IFacilityRepository extends JpaRepository<Facility, Integer> {
    ...
    @Query(value = "select f.* from `facility` f join `facility_type` ft on f.facility_type_id = ft.facility_type_id  where f.name like %:searchName% and ft.facility_type_name = :searchFacilityTypeName" ,nativeQuery = true )
